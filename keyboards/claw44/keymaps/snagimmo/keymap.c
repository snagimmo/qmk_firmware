...
#define KC_TO0 TO(_QWERTY)         // raise(layer1)
...
#define KC_G_WN OSM(MOD_LGUI)      // l-gui
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //`--------+--------+---------+--------+---------+--------/   \--------+---------+--------+---------+--------+--------'
                          KC_LT2  , KC_LAPO, KC_C_LBR, KC_SPC ,     KC_ENT , KC_C_RBR, KC_RAPC, KC_LT1
    //                 `----------+--------+---------+--------'   `--------+---------+--------+---------'
    ),
    ...
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
        KC_APP , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,     KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_NO  , KC_BSLS,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
        _______, KC_NO  , KC_NO  , KC_NO  , KC_INS , KC_NO  ,     KC_HOME, KC_PGDN, KC_PGUP, KC_END , KC_NO  , _______,
    //`--------+--------+--------+--------+--------+--------/   \--------+--------+--------+--------+--------+--------'
                          KC_TO2 , KC_LALT, KC_LCTL, KC_G_WN,     KC_NO  , KC_RCTL, KC_RALT, KC_NO
    //                  `--------+--------+--------+--------'   `--------+--------+--------+--------'
    ),

    [_LOWER] = LAYOUT( \
    //,--------+--------+--------+--------+--------+--------.   ,--------+--------+--------+--------+--------+--------.
        KC_NO  , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,     KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , _______,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
        KC_TO0 , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,     KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_NO  ,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
        _______, KC_F11 , KC_F12 , KC_NO  , KC_NO  , KC_NO  ,     KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , _______,
    //`--------+--------+--------+--------+--------+--------/   \--------+--------+--------+--------+--------+--------'
                          KC_CAPS, KC_LALT, KC_LCTL, _______,     _______, KC_RCTL, KC_RALT, KC_TO3
    //                  `--------+--------+--------+--------'   `--------+--------+--------+--------'
    ),

    [_NUMPAD] = LAYOUT( \
    //,--------+--------+--------+--------+--------+--------.   ,--------+--------+--------+--------+--------+--------.
        KC_NO  , RESET  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,     KC_PSLS, KC_P7  , KC_P8  , KC_P9  , KC_EQL , _______,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
        KC_TO0 , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,     KC_PAST, KC_P4  , KC_P5  , KC_P6  , KC_NO  , KC_NO  ,
    //|--------+--------+--------+--------+--------+--------|   |--------+--------+--------+--------+--------+--------|
        _______, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,     KC_PMNS, KC_P1  , KC_P2  , KC_P3  , KC_PDOT, _______,
    //`--------+--------+--------+--------+--------+--------/   \--------+--------+--------+--------+--------+--------'
                          KC_CAPS, KC_LALT, KC_LCTL, _______,     _______, KC_RCTL, KC_PPLS, KC_P0
    //                  `--------+--------+--------+--------'   `--------+--------+--------+--------'
    ),
};
